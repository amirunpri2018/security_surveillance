...
SECRET_KEY = 'f3jk6qbk6w!c#ro*xq3-1664ip6dz#05#az59jj4hi4+$#s3j4'
...
TIME_ZONE = 'Asia/Kolkata'   # Setting IST (Indian Standard Time)
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "security_serveillance/static"),
]
